...
const PenguinIcon = ({ className }: { className?: string }) => (
    <svg
        ...
        className={className}
    >
        <path d="M12 10a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2Z" fill="currentColor"/>
        <path d="M11 14V9a1 1 0 0 1 1-1h.5a1 1 0 0 1 1 1v2"/>
        <path d="M16.5 15.5a2.5 2.5 0 1 1-3.16-3.16" fill="currentColor"/>
